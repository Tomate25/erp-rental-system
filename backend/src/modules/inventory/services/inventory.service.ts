  ...
  async create(createEquipmentDto: CreateEquipmentDto, empresaId: string) {
    ...
    return this.prisma.equipo.create({
      data: {
        ...
        precioRentaHora: createEquipmentDto.precioRentaHora !== undefined ? createEquipmentDto.precioRentaHora : null,
        minimoHoras: createEquipmentDto.minimoHoras !== undefined ? createEquipmentDto.minimoHoras : 4,
        tipoControl: createEquipmentDto.tipoControl || undefined,
        costoAdquisicion: createEquipmentDto.costoAdquisicion !== undefined ? createEquipmentDto.costoAdquisicion : null,
        fechaAdquisicion: createEquipmentDto.fechaAdquisicion ? new Date(createEquipmentDto.fechaAdquisicion) : null,
  ...
  async update(id: string, updateEquipmentDto: UpdateEquipmentDto, empresaId: string) {
    ...
    return this.prisma.equipo.update({
      ...
      data: {
        ...
        precioRentaHora: updateEquipmentDto.precioRentaHora !== undefined ? updateEquipmentDto.precioRentaHora : undefined,
        minimoHoras: updateEquipmentDto.minimoHoras !== undefined ? updateEquipmentDto.minimoHoras : undefined,
        tipoControl: updateEquipmentDto.tipoControl !== undefined ? updateEquipmentDto.tipoControl : undefined,
        costoAdquisicion: updateEquipmentDto.costoAdquisicion !== undefined ? updateEquipmentDto.costoAdquisicion : undefined,
        fechaAdquisicion: updateEquipmentDto.fechaAdquisicion !== undefined ? (updateEquipmentDto.fechaAdquisicion ? new Date(updateEquipmentDto.fechaAdquisicion) : null) : undefined,
